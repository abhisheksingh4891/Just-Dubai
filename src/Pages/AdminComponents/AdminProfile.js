...
const AdminProfile = () => {
  ...
  return (
    <div
      className="container-fluid px-1 d-flex flex-column min-vh-100"
      style={{ backgroundColor: "rgba(232, 235, 231)", fontFamily:"Raleway" }}
    >
                            ...
                            {!editMode ? (
                              <>
                                ...
                                <div className="row pt-1">
                                  <div className="col-6 mb-3">
                                    <h6>Phone</h6>
                                    <p className="text-muted" style={{fontFamily:"none"}}>
                                      {profile.phone}
                                    </p>
                                  </div>
                                  <div className="col-6 mb-3">
                                  ...
                                  <div className="row pt-1">
                                    <div className="col-6 mb-3">
                                      ...
                                      <input
                                        ...
                                        onChange={handleChange}
                                        style={{fontFamily:"none", fontSize:"18px"}}
                                      />
                                    </div>
                                  </div>

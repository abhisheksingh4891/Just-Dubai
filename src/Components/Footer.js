...
const Footer = () => {
  return (
    <div className="footer text-white p-2 bg-dark" style={{  fontFamily:'Raleway', zIndex:2000}}>
      <div className="container">
        ...
        <h2 className="text-center fs-6 pt-2">Copyright @ 2024. Created by Just Dubai</h2>
      </div>
    </div>
  );
}
